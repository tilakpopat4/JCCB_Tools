...
<svg viewBox="0 0 500 500" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="250" y="270" font-family="'Noto Sans Gujarati', 'Gujarati MT', sans-serif" font-size="44" font-weight="bold" fill="#041562" text-anchor="middle" dominant-baseline="middle">
    શ્રી
  </text>
</svg>
`;
