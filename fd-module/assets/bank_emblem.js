// Official High-Resolution Bank Emblem SVG Vector
const TJCCB_LOGO_SVG = `
<svg viewBox="0 0 500 500" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
  <!-- Circular Base -->
  <circle cx="250" cy="250" r="242" fill="#ffffff" stroke="#002b99" stroke-width="14"/>
  <circle cx="250" cy="250" r="222" fill="none" stroke="#002b99" stroke-width="4"/>
  ...
  <text fill="#002b99" font-family="'Plus Jakarta Sans', 'Arial Black', sans-serif" font-size="28.5" font-weight="900" letter-spacing="2.5">
    <textPath href="#topTextArc" startOffset="50%" text-anchor="middle">
      THE JUNAGADH COMMERCIAL CO-OPERATIVE BANK LTD.
    </textPath>
  </text>

  <text fill="#002b99" font-family="'Plus Jakarta Sans', 'Arial Black', sans-serif" font-size="34" font-weight="900" letter-spacing="4">
  ...
  <!-- Inner Cogwheel Ring -->
  <circle cx="250" cy="250" r="140" fill="none" stroke="#002b99" stroke-width="14"/>
  ...
  <g stroke="#002b99" stroke-width="9" stroke-linecap="round" stroke-linejoin="round" fill="none">
    ...
    <path d="M 140 315 L 240 315 L 232 328 L 148 328 Z" fill="#002b99" />
    ...
    <path d="M 260 315 L 360 315 L 352 328 L 268 328 Z" fill="#002b99" />
  </g>

  <!-- Central Auspicious 'શ્રી' Symbol -->
  <text x="250" y="270" font-family="'Noto Sans Gujarati', 'Gujarati MT', sans-serif" font-size="44" font-weight="bold" fill="#002b99" text-anchor="middle" dominant-baseline="middle">
    શ્રી
  </text>
</svg>
`;
